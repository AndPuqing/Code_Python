...
(0, t.VantComponent)({
    ...
    methods: {
        ...
        setValues: function() {
            ...
            if (c) {
                var a = [];
                if (a.push(c.setColumnValues(0, r, !1)), a.push(c.setColumnValues(1, s, !1)), s.length && "00" === i.slice(2, 4)) {
                    var u = e(s, 1);
                    i = u[0].code;
                }
                return a.push(c.setColumnValues(2, this.getList("county", i.slice(0, 4)), !1)), 
                Promise.all(a).catch(function() {}).then(function() {
