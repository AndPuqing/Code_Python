...
Component({
    ...
    methods: {
        ...
        loadSource: function(r) {
            var e = this.data.controls[r.id] ? this.data.controls[r.id].index + 1 : 1;
            return e < r.dataset.source.length && (this.setData(t({}, "controls." + r.id + ".index", e)), 
            !0);
        },
        play: function(t) {
            if (this._top.group && this._top.group.pause(this._top.i), this._top.videoContexts.length > 1 && this._top.data.autopause) for (var r = this._top.videoContexts.length; r--; ) this._top.videoContexts[r].id != t.currentTarget.id && this._top.videoContexts[r].pause();
        },
        imgtap: function(t) {
            ...
            if (!r.ignore) {
                ...
                if (this._top.triggerEvent("imgtap", {
                    ...
                    var i = this._top.imgList, o = i[r.i] ? i[r.i] : (i = [ r.src ], r.src);
                    wx.previewImage({
                        current: o,
                        urls: i
                    });
        ...
        linkpress: function(t) {
            var r = !0, e = t.currentTarget.dataset.attrs;
            e.ignore = function() {
                return r = !1;
        ...
        loadVideo: function(r) {
            this.setData(t({}, "controls." + r.currentTarget.id, {
                play: !0,
                index: 0
            }));
        }
