...
var a = t(require("../../utils/we-moment-with-locales")), i = t(require("vant-weapp/toast/toast")), n = t(require("../../utils/config")), s = t(require("vant-weapp/dialog/dialog")), o = getApp(), r = {}, d = "start", u = "location", l = null, c = null, m = {}, h = null, p = "initType", f = "start", g = 0;
...
Page({
    ...
    onLoad: function(t) {
        m = {}, t.id ? (l = t.id, this.getDetail(), this.setData({
            id: l
        })) : l = null, t.student ? (h = t.student, this.setData({
            end: n.default.end,
            is_guilin: !0,
            student: t.student
    ...
    toggleArea: function(t) {
        u = t.currentTarget.dataset.model, d = t.currentTarget.dataset.type, h && "end" == d || this.setData({
    ...
    areaSelect: function(t) {
        ...
        if ("location" == u) {
            ...
            this.setData((o = {}, e(o, u + "[" + d + "]", r), e(o, "areaShow", !1), o), function() {});
        }
    },
    getmembers: function() {
        var t = this;
    ...
    save: function(t) {
        var e = this, a = this.data, n = a.start, s = a.end, r = a.date, d = a.result, u = a.members, h = a.stopovers, p = a.label, f = a.radio, g = (a.initType, 
        a.station), v = a.togethers, y = (a.arriveTime, a.arrive, a.is_guilin), D = (a.guet_back_shcool_type, 
        a.transports);
        if (r) if (n && n.areaid) if (s && s.areaid) if (g.name || !y) if (g.name || y) {
            ...
            g && (_.end.station = g.name), m.__version && (_.__version = m.__version), c ? _.members.push({
                uid: c
            }) : _.members.push({
                uid: o.globalData.self.id
            }), h.length > 0 && (_.stopovers = [], h.map(function(t) {
                t.areaid && _.stopovers.push(t);
            })), u && u.length > 0 && u.map(function(t, e) {
                d.indexOf(String(e)) > -1 && _.members.push(t);
            });
            for (var b in D) {
                if (!D[b].initType || !D[b].initType.name) return void (0, i.default)("请输入中转交通方式" + (Number(b) + 1) + "的交通方式");
                if (_.type = (_.type ? _.type : "") + D[b].initType.name, b < D.length - 1 && (_.type = _.type + "|"), 
                !D[b].train_number) return void (0, i.default)("请输入交通中转" + (Number(b) + 1) + p[D[b].initType.name]);
                _.train_number = (_.train_number ? _.train_number : "") + D[b].train_number, b < D.length - 1 && (_.train_number = _.train_number + "|"), 
                D[b].coach ? (_.coach = (_.coach ? _.coach : "") + D[b].coach, b < D.length - 1 && (_.coach = _.coach + "|")) : b < D.length - 1 && (_.coach = "|"), 
                D[b].seat ? (_.seat = (_.seat ? _.seat : "") + D[b].seat, b < D.length - 1 && (_.seat = _.seat + "|")) : b < D.length - 1 && (_.seat = "|");
            }
            if (v.length > 0) {
                for (var T in v) {
                    if (!v[T].name) return void (0, i.default)("请输入同行人" + (Number(T) + 1) + "正确的同行人名字");
                    if (!v[T].relationship) return void (0, i.default)("请输入同行人" + (Number(T) + 1) + "与您的关系");
                    if (!v[T].idcard || 18 != v[T].idcard.length) return void (0, i.default)("请输入正确的同行人" + (Number(T) + 1) + "身份证号码");
                    if (!v[T].phone || 11 != v[T].phone.length) return void (0, i.default)("请输入正确的同行人" + (Number(T) + 1) + "电话");
                }
                _.members = _.members.concat(v);
            }
            f && 0 != f.length ? (i.default.loading({
                ...
                zIndex: 1e5,
                mask: !0
            }), l ? (_.id = l, o.services("api/app/community/itinerary/details").get({
                id: l
            }).then(function(t) {
                t && t.data.Success ? (_.__version = t.data.Result.__version, o.services("api/app/community/itinerary").post(_).then(function(t) {
            ...
            })) : o.services("api/app/community/itinerary").post(_).then(function(t) {
                t && t.data.Success ? (i.default.success("操作成功"), e.setData({
                    result: []
                }), setTimeout(function() {
                    wx.navigateBack({
